...
import 'react-big-calendar/lib/css/react-big-calendar.css'; // Make sure to import the CSS
        ...
        <div className="home">
            ...
            <div className="homeContainer">
                ...
                {open && (
                    ...
                    {/* calender */}
                    <button onClick={handleClose} className="w-16 animate-bounce h-16 border border-border z-50 bg-subMain text-white rounded-full flex-colo fixed bottom-8 right-12 button-fb"
                    >
