...
import { useUpdateAccountInfoMutation } from '../../../features/patient/updateProfile';
...
const PatientProfileModal = ({ showModal, handleClose, details, onUpdateSuccess }) => {
    const [updateAccountInfo, { isLoading, error }] = useUpdateAccountInfoMutation();
    ...
    const handleSubmit = async (values, { setSubmitting, resetForm }) => {
        setSubmitting(true);
        try {
            await updateAccountInfo(values).unwrap();
