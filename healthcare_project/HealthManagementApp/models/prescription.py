...
class Prescription(models.Model):
    ...
    refill_count = models.IntegerField(default=0)  # Tracks the number of refills
    last_refilled_date = models.DateField(null=True, blank=True)  # Date of last refill
    refill_request_pending = models.BooleanField(default=False)  # Tracks if a refill request is pending
    prescription_approved = models.BooleanField(default=True)  # Tracks the approval status of the prescription
