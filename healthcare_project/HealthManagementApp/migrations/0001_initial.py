# Generated by Django 4.2.6 on 2024-05-07 22:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='HealthManagementApp.location')),
                ('weekly_availability', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='HealthManagementApp.weeklyavailability')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FollowupNote', models.TextField(blank=True, null=True)),
                ...
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HealthManagementApp.doctor')),
                ('meeting_link', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.fields.CharField, to='HealthManagementApp.zoom_modal')),
                ('patient', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='HealthManagementApp.patient')),
